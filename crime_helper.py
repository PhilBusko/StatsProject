...
ARREST_TKM_AGENCY = '/api/data/arrest/agencies/offense/{ori}/{variable}/{since}/{until}'
ARREST_TKM_AGENCY_OFFENSE = '/api/data/arrest/agencies/{ori}/{offense}/{variable}/{since}/{until}'
